...
public class Ventas {
	...
	public Ventas(String idVenta,String Id_Producto,int Cantidad,double Precio,double Descuento,double Total_importe,int Fecha,int Hora,int IdEmpleado,String idEstado,String idLote) {
		super();
