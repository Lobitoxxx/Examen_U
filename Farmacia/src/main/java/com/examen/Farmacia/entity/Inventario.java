...
public class Inventario {
	...
	public Inventario(String idProducto,String Nombre,int Id_presentacion,int Id_laboratorio,double Concentracion,double Existencia_minima,String idPrescripcion) {
		super();
